...
import com.example.modulo_05.onBoardingViews.ButtonFinish
import com.example.modulo_05.onBoardingViews.LoaderData
import com.example.modulo_05.onBoardingViews.PagerIndicator
...
fun OnBoardingPager(
    ...
    Box(modifier = modifier) {
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            HorizontalPager(
                state = pagerState,
                count = item.size // Pass page count here
            ) { page ->
                Column(
                    modifier = Modifier
                        .padding(60.dp)
